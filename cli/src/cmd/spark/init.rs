...
use crate::{
    cmd::{spark::install::DependencyInstallOpts, Cmd},
    utils::{p_println, Git},
};
...
impl Cmd for InitArgs {
    ...
    fn run(self) -> eyre::Result<Self::Output> {
        ...
        p_println!(!quiet => "    {} spark project",   Paint::green("Initialized"));
        Ok(())
    }
}

...
impl EtherscanSourceProvider for EtherscanFlattenedSource {
    fn source(
        ...
        eyre::ensure!(
            ...
            "When using flattened source, bytecodeHash must be set to ipfs because Etherscan uses IPFS in its Compiler Settings when re-compiling your code. BytecodeHash is currently: {}. Hint: Set the bytecodeHash key in your foxar.toml :)",
            bch,
        );
...
This could be a bug, please inspect the output of `spark flatten {}` and report an issue.

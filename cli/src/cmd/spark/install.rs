...
/// CLI arguments for `spark install`.
#[derive(Debug, Clone, Parser)]
#[clap(override_usage = "spark install [OPTIONS] [DEPENDENCIES]...
    spark install [OPTIONS] <github username>/<github project>@<tag>...
    spark install [OPTIONS] <alias>=<github username>/<github project>@<tag>...
    spark install [OPTIONS] <https:// git url>...")]

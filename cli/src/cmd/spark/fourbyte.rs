...
/// CLI arguments for `spark upload-selectors`.
...
impl UploadSelectorsArgs {
    ...
    pub async fn run(self) -> eyre::Result<()> {
        shell::println(Paint::yellow("Warning! This command is deprecated and will be removed in v1, use `spark selectors upload` instead"))?;

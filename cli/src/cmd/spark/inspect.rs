use crate::{
    cmd::{spark::build::CoreBuildArgs, Cmd},
...
/// CLI arguments for `spark inspect`.
...
impl Cmd for InspectArgs {
    ...
    fn run(self) -> eyre::Result<Self::Output> {
        ...
        trace!(target: "spark", ?field, ?contract, "running spark inspect");
        ...
        trace!(target: "spark", artifact=?found_artifact, input=?contract, "Found contract");

...
orbitalis_config::merge_impl_figment_convert!(ChiselParser, opts, evm_opts);
        ...
        match next_string {
            Ok(line) => {
                ...
                match dispatcher.dispatch(&line).await {
                    ...
                    DispatchResult::Failure(None) => eprintln!("{}\nPlease Report this bug as a github issue if it persists: https://github.com/orbitalis-rs/orbitalis/issues/new/choose", Paint::red("⚒️ Unknown Chisel Error ⚒️")),
                }
            }
